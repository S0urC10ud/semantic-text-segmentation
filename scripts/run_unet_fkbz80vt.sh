#!/usr/bin/env bash
# run_unet_fkbz80vt.sh — Start the GCP VM with a self-contained training job.
#
...
#
# Reproduction of U-Net run fkbz80vt.
...
echo "=============================="
echo "🏋️ Starting U-Net (fkbz80vt) training from scratch ..."
echo "  \$(date)"
echo "=============================="
