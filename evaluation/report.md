...
| --- | --- | --- | --- | --- |
| Any non-wrapper | 1203/2000 | 556/2000 | 0.38 | 72.6% |
...
| --- | --- | --- | --- | --- |
| Any non-wrapper | 1917/2000 | 1331/2000 | 0.68 | 97.9% |
| Correct payload | 1790/2000 | 1736/2000 | 0.83 | 90.8% |
...
| Scenario | Coverage ≥50% | IoU ≥50% | Avg IoU | Coverage |
| --- | --- | --- | --- | --- |
| Any non-wrapper | 953/2000 | 298/2000 | 0.25 | 52.2% |
| Correct payload | 619/2000 | 568/2000 | 0.26 | 33.4% |
...
- High confusions: csharp->c_family 28051 (12.8%), javascript_typescript->c_family 27150 (15.3%), powershell->c_family 24834 (10.6%), python->c_family 23082 (14.2%), python->javascript_typescript 22962 (14.1%)
...
| --- | --- | ---: | ---: | --- | ---: | ---: | --- |
| csharp | 114/221 | 0.63 | 98.1% | 186/221 | 0.83 | 84.8% (overall 85.8%) | c_family (12.8%), java (0.6%), javascript_typescript (0.2%) |
| go | 35/213 | 0.26 | 40.6% | 6/213 | 0.05 | 4.9% (overall 60.0%) | c_family (13.0%), javascript_typescript (8.7%), dockerfile (2.3%) |
| java | 90/212 | 0.54 | 80.3% | 117/212 | 0.54 | 47.9% (overall 69.2%) | c_family (11.6%), javascript_typescript (9.2%), html (3.2%) |
| javascript_typescript | 70/263 | 0.39 | 79.6% | 97/263 | 0.35 | 62.5% (overall 73.0%) | c_family (15.3%), java (2.0%), csharp (1.9%) |
| php | 38/232 | 0.27 | 42.4% | 18/232 | 0.09 | 9.1% (overall 56.1%) | javascript_typescript (10.9%), c_family (9.9%), shell (2.4%) |
| powershell | 101/208 | 0.52 | 90.5% | 129/208 | 0.57 | 77.6% (overall 81.6%) | c_family (10.6%), csharp (2.9%), shell (1.1%) |
| python | 43/219 | 0.33 | 52.3% | 1/219 | 0.01 | 1.3% (overall 56.7%) | c_family (14.2%), javascript_typescript (14.1%), java (2.3%) |
| ruby | 32/228 | 0.25 | 43.2% | 14/228 | 0.08 | 10.0% (overall 63.4%) | c_family (15.0%), javascript_typescript (5.9%), python (2.0%) |
| shell | 33/204 | 0.25 | 42.8% | 36/204 | 0.17 | 17.1% (overall 66.9%) | c_family (12.6%), dockerfile (4.4%), powershell (3.1%) |
...
- High confusions: text->c_family 62214 (7.1%), javascript_typescript->java 2937 (3.6%), ruby->python 2391 (3.0%), sql->c_family 2300 (3.1%), dockerfile->c_family 1936 (2.6%)
...
- High confusions: visual_basic->sql 1261 (1.1%), yaml->encoding_base64 1260 (1.2%), javascript_typescript->java 909 (0.8%), csharp->encoding_base64 375 (0.4%), go->json 361 (0.3%)
...
- High confusions: visual_basic->c_family 34525 (8.7%), powershell->c_family 29886 (8.8%), javascript_typescript->c_family 29541 (8.6%), css->c_family 29181 (7.9%), yaml->c_family 28877 (8.6%)
...
- High confusions: encoding_base58->c_family 40863 (15.7%), encoding_base85->c_family 34814 (13.8%), css->c_family 32620 (14.6%), javascript_typescript->c_family 26710 (14.0%), java->c_family 26083 (16.1%)
...
| javascript_typescript | 190865 | 0.8127 |
| java | 161768 | 0.8020 |
| text | 98870 | 0.7683 |
| __unknown__ | 0 | nan |
...
| --- | --- | --- | ---: | ---: | --- |
| Any non-wrapper | 1917/2000 | 1331/2000 | 0.68 | 97.9% | c_family (73.8%), csharp (4.7%), powershell (3.4%) |
| Correct label | 1790/2000 | 1736/2000 | 0.83 | 90.8% | — |
...
- High confusions: css->c_family 6962 (5.4%), javascript_typescript->c_family 6842 (5.8%), powershell->c_family 6698 (5.2%), csv->c_family 6354 (5.3%), visual_basic->c_family 6331 (5.5%)

| Label | Support | Accuracy |
| --- | ---: | ---: |
| c_family | 122734 | 0.9664 |
| encoding_base64 | 111376 | 0.9574 |
| dockerfile | 87849 | 0.9557 |
...
| visual_basic | 115987 | 0.9081 |
| javascript_typescript | 118979 | 0.8916 |
| __unknown__ | 0 | nan |
...
- High confusions: javascript_typescript->c_family 3682 (3.1%), go->c_family 3659 (3.0%), java->c_family 3632 (3.3%), csv->c_family 3549 (2.9%), encoding_base58->c_family 3479 (3.1%)
...
| java | 109309 | 0.9348 |
| javascript_typescript | 116990 | 0.9334 |
| shell | 72352 | 0.9306 |
...
- High confusions: rust->c_family 2126 (1.8%), csharp->c_family 2078 (1.9%), encoding_base85->c_family 2032 (1.9%), go->c_family 1954 (1.6%), java->c_family 1927 (1.7%)
...
| Scenario | Coverage ≥50% | IoU ≥50% | Avg IoU | Coverage | Top misclassifications |
| --- | --- | --- | ---: | ---: | --- |
| Any non-wrapper | 953/2000 | 298/2000 | 0.25 | 52.2% | c_family (10.0%), csharp (9.8%), powershell (6.7%) |
| Correct label | 619/2000 | 568/2000 | 0.26 | 33.4% | — |

## Throughput Benchmarks

| Task | Device | Samples | Total Bytes | Throughput | Latency (s) | RSS Δ (MB) | Device Δ (MB) |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| throughput_1024 | cuda | 8 | 8192 | 17.83 KB/s | 0.45 | n/a | n/a |
| throughput_10240 | cuda | 8 | 81920 | 76.16 KB/s | 1.05 | n/a | n/a |
| throughput_102400 | cuda | 8 | 819200 | 86.81 KB/s | 9.22 | n/a | n/a |
| throughput_1048576 | cuda | 8 | 8388608 | 95.79 KB/s | 85.52 | n/a | n/a |

Report generated at 2025-11-09 16:13:26